                      ...
                      >
                        ...
                        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
                          <div className="w-full md:w-1/2 aspect-square rounded-[2rem] overflow-hidden border-4 border-primary/20 shadow-xl relative z-10">
                            <img 
                              src={member.image_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(member.name)}&background=000&color=fff`} 
                          ...
                          <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
                            <div className="space-y-1">
                              <h4 className="text-xl md:text-2xl font-black text-foreground uppercase tracking-tight leading-tight">
                                MEET OUR <span className="text-primary underline decoration-4 underline-offset-8">{member.role}</span>
                              </h4>
                            </div>
                            
                            <div className="inline-block px-6 py-2.5 rounded-xl bg-primary text-white font-black text-lg tracking-wider border-b-4 border-blue-700 shadow-lg transform -rotate-1">
                              {member.name}
                            </div>
                            
                            <p className="text-muted-foreground leading-relaxed text-lg font-medium italic">
                              "{member.bio || `Leading with vision and dedication to drive the NSS mission forward and inspire our volunteers.`}"
                            </p>
                          </div>
                        </div>
